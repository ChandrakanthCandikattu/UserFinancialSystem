...
<body>
	...
	<section id="loginSection">
		<div id="topSection">
			...
			<div id="crdForm">
				...
				<form:form autocomplete="false" method="POST"
					action="${pageContext.request.contextPath}/req" modelAttribute="login">
					<table id="crdtbl">
						<tr>
							<td>
						...
						<tr>
							<td>
								...
								placeholder="Password"></input> --> <form:password path="passWord"
									cssClass="ucExstInp" maxlength="15" />
							</td>
						</tr>
					</table>
		...
		<section id="footerSection">
			<div id="bComps">
				<span class="bComp0 bComp01">TERMS OF USE</span> <span
					class="bComp1">ABOUT</span> <span class="bComp2">GET IN
					TOUCH</span> <span class="bComp3">JOIN US</span>
			</div>
			<div id="cright">
